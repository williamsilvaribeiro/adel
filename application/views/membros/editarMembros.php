    ...
    <div class="widget-box">
        ...
        <section class="panel panel-default">
            <header class="panel-heading text-right bg-light">
                ...
                <span class="hidden-sm">Informacoes referentes aos Membros da Vila Juracy</span>
            </header>
            <div class="panel-body">
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="profile-1">
                        ...
                        <section class="panel panel-default">
                            <header class="panel-heading">Dados Pessoais</header>
                            ...
                            <div class="panel-body">
                                ...
                                if (!empty($result->foto_url)) {
                                    $imagem = base_url() . 'fotosMembros/' . $result->foto_url;
                                } else {
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 ">
                                                    <h4>Não há imagem cadastrata para
                                                        o <?php echo $result->cargo . ' <strong> ' . $result->nomeMembro . '</strong>' ?>
                                                        . Por favor, <a href="#modalEditarFoto"
                                                                        class="sumb" role="button"
                                                                        data-toggle="modal"><strong>clique
                                                                aqui</strong></a>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="col-md-10">
                                            <input id="emissorRg" name="emissorRg" type="text"
                                                   class="form-control"
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <input id="dataBatismo" class="form-control" type="text"
                                                       name="dataBatismo"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="locaBatismoAguas" name="locaBatismoAguas" type="text"
                                               class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="locaConversao" name="locaConversao" type="text"
                                               class="form-control"
                                        ...
                                        <div class="btn-toolbar m-b-sm btn-editor" data-role="editor-toolbar"
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a data-edit="fontSize 5"><font
                                                                size="5">Grande</font></a></li>
                                                    <li><a data-edit="fontSize 3"><font
                                                                size="3">Normal</font></a></li>
                                                    <li><a data-edit="fontSize 1"><font size="1">Pequena</font></a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="btn-group">
                                                <a class="btn btn-default btn-sm" data-edit="bold"
                                                   title="Negrito (Ctrl/Cmd+B)"><i
                                            ...
                                            <div class="btn-group">
                                                <a class="btn btn-default btn-sm" data-edit="justifyleft"
                                                   title="Alinhar Esquerda (Ctrl/Cmd+L)"><i
                                                ...
                                                <a class="btn btn-default btn-sm" data-edit="justifyright"
                                                   title="Align Direita (Ctrl/Cmd+R)"><i
                                                        class="fa fa-align-right"></i></a>
                                                <a class="btn btn-default btn-sm" data-edit="justifyfull"
                                                   title="Justificar (Ctrl/Cmd+J)"><i
                                            ...
                                            <div class="btn-group">
                                                <a class="btn btn-default btn-sm" data-edit="undo"
                                                   title="Desfazer (Ctrl/Cmd+Z)"><i
                                                        class="fa fa-undo"></i></a>
                                                <a class="btn btn-default btn-sm" data-edit="redo"
                                                   title="Refazer (Ctrl/Cmd+Y)"><i
                                                        class="fa fa-repeat"></i></a>
                                            </div>
                                        </div>
                                        <div id="editor" name="editor" class="form-control"
                                             style="overflow:scroll;height:250px;max-height:250px">Digite aqui a
                                            observacoes.....
                                        </div>
...
<div class="modal fade" id="modalEditarFoto">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo base_url() ?>membros/gerenciarImagemMembro/<?php echo $result->idMembro ?>"
                  method="post"
                ...
                <div class="modal-body">
                    <input type="hidden" id="idImagemAntiga" name="idImagemAntiga" value="<?php echo $result->idFotos ?>"/>
                    <input type="hidden" id="idMembro" name="idMembro"
                           value="<?php echo $result->idMembro ?>"/>
                    <input type="hidden" id="categoriaEditarFoto" name="categoriaEditarFoto"
                           value="<?php echo $result->cargo ?>"/>
                    <input type="hidden" id="urlarquivos" name="arquivoImagemAntiga" value="<?php echo $result->foto_url ?>"/>
                    <h5 style="text-align: center">Escolha a nova foto</h5>

                    <div class="form-control">
                        <input type="file" id="imagemMembro" name="imagemMembro" onchange="loadFile(event)">
                    </div>
