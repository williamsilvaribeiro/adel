        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <div class="span12 well">
                    ...
                    <form class="form-inline" action="<?php echo base_url()?>membros/visualizarAniversariantes" name="formRelatorio" target="Postagem" method="get">
...
function abreRelatorioMensal() {
   ...
   function relatorioAniversariantesMes() {
       var url = "<?php echo base_url() ?>membros/visualizarAniversariantesMesAtual/";
