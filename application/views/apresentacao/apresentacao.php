...
<a id="editar" href="#modalEditar" data-toggle="modal" role="button" 
idApresentacao="'.$r->idApresentacao.'" dataNascimento="' . date('d/m/Y', strtotime($r->dataNascimento)) . '" dataApresentacao="' . date('d/m/Y', strtotime($r->dataApresentacao)) . '" nome="'.$r->nome.'"  sexo="'.$r->sexo.'" nomePai="'.$r->nomePai.'" nomeMae="'.$r->nomeMae.'"title="Editar"><i class="icon-pencil"></i></a></td>';
                    echo '<td>
...
<div class="modal fade" id="modalEditar">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h3 class="m-b-none">Editar Criança para Apresentação</h3>
            </div>
            <div class="panel-body">
                ...
                <form class="form-horizontal" id="formAdicionarMudanca" action="<?php echo base_url() ?>apresentacao/editar" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-md-6">
                                    <input id="dataNascimentoEditar" class="datepicker form-control" type="text" name="dataNascimento"  placeholder="Data de Nascimento"  />
                                </div>
                            </div>
                        </div>
                    </div>  
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-labelNegrito">Data Apresentação</label>
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-md-6">
                                    <input id="dataApresentacaoEditar" class="datepicker form-control" type="text" name="dataApresentacao" placeholder="Data da Apresentação"  />
                                </div>
                            </div>
                        </div>
                    </div>   
                    ...
                    <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="sexo"  id="sexoEditar" class="form-control">
                                                <option></option>
                                                <option value="">--------</option>
                                                <option value="Masculino">Masculino</option>
                                                <option value="Feminino">Feminino</option>
                     ...
                     <div class="form-group">
                        <label class="col-lg-2 control-labelNegrito" for="morador">Nome Pai*</label>
                        <div class="col-lg-10">
                            <input id="nomePaiEditar" type="text" name="nomePai" class="form-control" >
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        <label class="col-lg-2 control-labelNegrito" for="morador">Mãe*</label>
                        <div class="col-lg-10">
                            <input id="nomeMaeEditar" type="text" name="nomeMae" class="form-control" >
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).on('click', '#editar', function(event) {
      $("#idEditar").val($(this).attr('idApresentacao'));
      $("#dataNascimentoEditar").val($(this).attr('dataNascimento'));
      $("#nomeEditar").val($(this).attr('nome'));
      $("#sexoEditar").val($(this).attr('sexo'));
      $("#dataApresentacaoEditar").val($(this).attr('dataApresentacao'));
      $("#nomePaiEditar").val($(this).attr('nomePai'));
      $("#nomeMaeEditar").val($(this).attr('nomeMae'));
