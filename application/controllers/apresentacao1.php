...
class Apresentacao extends CI_Controller {
    ...
    function editar() {
        ...
        if ($this->form_validation->run('agenda') == false) {
            ...
            try {
                ...
                $dataAgenda = explode('/', $dataAgenda);
                $dataAgenda = $dataAgenda[2].'-'.$dataAgenda[1].'-'.$dataAgenda[0];
            ...
            $data = array(
                ...
                'nomeClienteAgenda' => $this->input->post('nomeClienteAgenda'),
                'telefoneCliente' => $this->input->post('telefoneCliente'),
                'statusAgenda' => $this->input->post('statusAgenda'),
                'interesseCliente' => $this->input->post('interesseCliente')
            );
        ...
        $this->data['result'] = $this->agenda_model->getById($this->uri->segment(3));
        $this->data['view'] = 'agenda/editarAgenda';
        $this->load->view('tema/topo', $this->data);
